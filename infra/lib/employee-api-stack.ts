...
export class EmployeeApiStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    loadBalancerSecurityGroup.addEgressRule(
      ...
      'Allow health checks and application traffic to ECS dynamic host ports'
    );
    ...
    const record = new route53.CfnRecordSet(this, 'ApiAliasRecord', {
      hostedZoneId: hostedZoneId.valueAsString,
      name: domainName.valueAsString,
      type: 'A',
      aliasTarget: {
    ...
    record.cfnOptions.condition = dnsCondition;
